...
class NearEarthObject:
    ...
    def __init__(
        ...
        :param designation: The primary designation of the NEO (required).
        :param name: The IAU name of the NEO (optional).
        :param diameter: The diameter in kilometers (optional, use float('nan') if unknown).
...
class CloseApproach:
    ...
    def __init__(self, designation="", time=None, distance=0.0, velocity=0.0):
        ...
        :param designation: The primary designation of the NEO making the approach.
        :param time: The time of close approach (NASA format string).
